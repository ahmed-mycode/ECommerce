...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/plugins/animate/animate.css')}}">
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/vendors.css')}}">
    ...
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/app.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/custom-rtl.css')}}">
    <!-- END MODERN CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css"
          href="{{asset('admin/'.get_folder().'/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/core/colors/palette-gradient.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/fonts/simple-line-icons/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/core/colors/palette-gradient.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/pages/timeline.css')}}">
    ...
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/'.get_folder().'/style-rtl.css')}}">
    <!-- END Custom CSS-->
...
<!-- Begin SideBar-->
@include('admin_layouts.sidebare')
<!--End Sidebare-->
