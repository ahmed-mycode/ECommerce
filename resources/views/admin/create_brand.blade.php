                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-header">{{__('admin/brand.new.brand.h')}}</div>

                            <div class="card-body">
                                <form method="post" action="{{route('store.brand')}}" enctype="multipart/form-data" novalidate>
                                    @csrf

                                    <div class="form-group row">
                                        <label for="name"
                                               class="col-md-4 col-form-label text-md-right">{{__('admin/brand.name')}}</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-6 offset-md-4">
                                            <button type="submit"
                                                class="btn btn-primary">{{__('admin/category.save')}}
                                            </button>
                                        </div>
                                    </div>
                                </form>
